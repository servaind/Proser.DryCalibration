...
{
    public class DanielJunior2RMeasurer : ModbusMap
    {
        public DanielJunior2RMeasurer()
        {
            Measurer = UltrasonicModel.DanielJunior2R;

            MapMeasurer();
        }

        public DanielJunior2RMeasurer(ModbusMap map) : base(map) { }
        ...
        {
            //mapear argumentos para el calculo
            string[,] names = new string[,] {{"PctGoodA1", "A"}, {"PctGoodB1", "B"},
                                             {"PctGoodA2", "A"}, {"PctGoodB2", "B"}};

            int[] adds = new int[] { 67, 68, 71, 72 };
